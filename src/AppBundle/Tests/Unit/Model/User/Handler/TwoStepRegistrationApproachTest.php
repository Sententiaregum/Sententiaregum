...
use AppBundle\Model\User\Handler\TwoStepRegistrationApproach;
...
class TwoStepRegistrationApproachTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testApproveUser()
    {
        ...
        $roleRepo = $this->getMockWithoutInvokingTheOriginalConstructor(RoleReadRepositoryInterface::class);
        $roleRepo
            ->expects($this->at(0))
    ...
    /**
     * @return \AppBundle\Model\User\UserReadRepositoryInterface
     */
    private function getUserRepository()
    {
        return $this->getMock(UserReadRepositoryInterface::class);
    }

    /**
     * @return RoleReadRepositoryInterface
     */
    private function getRoleRepository()
    {
        return $this->getMockWithoutInvokingTheOriginalConstructor(RoleReadRepositoryInterface::class);
    }
}
